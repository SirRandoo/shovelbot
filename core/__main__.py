...
import click
from PyQt5 import QtCore, QtNetwork, QtWebEngine, QtWidgets

from QtUtilities import settings
from QtUtilities.utils import qmessage_handler
from utils.custom import QApplication

# Declarations
application = QApplication(sys.argv)

# Set up the web engine for (hopefully) no application freezes
...
def entry_info():
    click.echo_via_pager(
        ...
        f'Qt Version: {QtCore.QT_VERSION_STR}\n'
        f'PyQt5 Version: {QtCore.PYQT_VERSION_STR}'
    )
