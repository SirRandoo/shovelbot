...
if typing.TYPE_CHECKING:
    ...
    class ExtStub(typing.NamedTuple):
        NAME: str
        PATH: pathlib.Path

# Stub declaration
ExtensionStub: 'ExtStub' = collections.namedtuple('ExtensionUnloaded', ['NAME', 'PATH'])
...
class Extension(QtCore.QObject):
    ...
    # Signals
    stateChanged: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal(object)
    metaUpdated: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal()
    
    # before, after
    displayNameChanged: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal(str, str)
    versionChanged: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal(str, str)
    authorsChanged: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal(set, set)
    websiteChanged: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal(QtCore.QUrl, QtCore.QUrl)
    documentationChanged: typing.ClassVar[QtCore.pyqtSignal] = QtCore.pyqtSignal(QtCore.QUrl, QtCore.QUrl)
    ...
    # Instance attributes
    bot: 'widgets.ShovelBot' = dataclasses.field(init=False)
    ...
    def __post_init__(self, parent: QtCore.QObject = None):
        ...
        # Assignments
        self.bot = QtWidgets.QApplication.instance().client
    ...
    def teardown(self):
        ...
        for attr, inst in inspect.getmembers(self):
            ...
            if isinstance(inst, QtWidgets.QWidget):
                ...
                if inst.parent() == self.bot or inst.parentWidget() == self.bot:
                    continue
                ...
                # Ensure we don't forcibly delete bot's resources
                if inst.parent() == self.bot or inst.parent() == self.bot:
                    continue
